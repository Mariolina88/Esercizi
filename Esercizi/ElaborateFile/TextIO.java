...
/**
 * TextIO by David J. Eck (http://math.hws.edu/javanotes/) provides a set of static methods for reading and writing text.  By default, it reads
...
public class TextIO {
   ...
   /**
    * This is identical to getln(). Modified by R.Rigon to skip white spaces before reading
    */
